...
describe('skills CLI', () => {
  ...
  describe('no arguments', () => {
    it('should display banner', () => {
      ...
      expect(output).toContain('npx agentskillshub-cli add');
      expect(output).toContain('npx agentskillshub-cli update');
      expect(output).toContain('npx agentskillshub-cli init');
      expect(output).toContain('agentskillsforall.com');
    });
  });
  ...
  describe('unknown command', () => {
    it('should show error for unknown command', () => {
      ...
      expect(output).toMatchInlineSnapshot(`
        ...
        Run agentskillshub-cli --help for usage.
        "
      `);
    });
  });
