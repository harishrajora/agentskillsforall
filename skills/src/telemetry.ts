const TELEMETRY_URL = process.env.SKILLS_API_URL
  ? `${process.env.SKILLS_API_URL}/api/t`
  : 'https://www.agentskillsforall.com/api/t';
const AUDIT_URL = process.env.SKILLS_API_URL
  ? `${process.env.SKILLS_API_URL}/api/audit`
  : 'https://www.agentskillsforall.com/api/audit';
